...
interface GameDetailClientProps {
    game: any; // Type should ideally be shared, but using any for compatibility with existing data
}
...
export default function GameDetailClient({ game }: GameDetailClientProps) {
    ...
    const initialMedia = (() => {
        ...
        return game.heroImage || game.image || game.imageUrl; // Added fallback to imageUrl for compatibility
    })();
